#!/usr/bin/env node
/**
 * One-time script to add user_id and metadata columns to chats table.
 * Run this to fix the escalate_to_core_system tool.
 */
...
`
    ...
    console.log('   - Backfilled user_id from projects')
