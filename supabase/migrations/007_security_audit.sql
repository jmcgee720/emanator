...
-- ============================================
-- 0. SHARED_PREVIEWS bootstrap — ensure the table exists before we touch its policies
-- ============================================
-- The standalone migration 006 may not have been applied against every environment
-- (some DBs pre-date it). Creating here is idempotent and lets step 4 run cleanly.
