...
Testing validation gate endpoints at https://ai-builder-stream.preview.emergentagent.com
...
class TestBeforeApplyTester:
    def __init__(self):
        self.base_url = "https://ai-builder-stream.preview.emergentagent.com/api"
