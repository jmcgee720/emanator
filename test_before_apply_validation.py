...
Testing validation gate endpoints at https://aurora-glass-engine.preview.emergentagent.com
...
class TestBeforeApplyTester:
    def __init__(self):
        self.base_url = "https://aurora-glass-engine.preview.emergentagent.com/api"
