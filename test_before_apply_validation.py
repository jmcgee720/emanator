...
Testing validation gate endpoints at https://luxury-minimal-ui-1.preview.emergentagent.com
...
class TestBeforeApplyTester:
    def __init__(self):
        self.base_url = "https://luxury-minimal-ui-1.preview.emergentagent.com/api"
