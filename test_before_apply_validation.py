...
Testing validation gate endpoints at https://ai-builder-hub-47.preview.emergentagent.com
...
class TestBeforeApplyTester:
    def __init__(self):
        self.base_url = "https://ai-builder-hub-47.preview.emergentagent.com/api"
