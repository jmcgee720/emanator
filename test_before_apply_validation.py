...
Testing validation gate endpoints at https://trend-signal-labs.preview.emergentagent.com
...
class TestBeforeApplyTester:
    def __init__(self):
        self.base_url = "https://trend-signal-labs.preview.emergentagent.com/api"
