...
function buildProjectSystemPrompt(env) {
  return [
    ...
    '  4. ONLY THEN ACT. After the inventory + confirmation step, proceed with file saves / code edits. When saving image attachments to the project, use write_file with the user-confirmed target path. Mention each saved path so the user can verify.',
