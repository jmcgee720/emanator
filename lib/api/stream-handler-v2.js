...
function buildProjectSystemPrompt(env) {
  ...
  return [
    ...
    '',
    '3. **Present to user:**',
    '   "I cannot complete [task] because I lack [capability]. I\'ve drafted a Core System feature request below - should I escalate this?"',
    '   ',
    '   [Show the draft]',
    '   ',
    '   Options:',
    '   - "Yes" → provide copy-paste-ready text for Core System chat',
    '   - "No, just give me manual steps" → fall back to instructions',
    '   - "Yes, but modify X first" → revise the draft',
    '',
    '4. **Do NOT:**',
    '   - ❌ Silently fall back to manual instructions without offering escalation',
    '   - ❌ Say "this isn\'t possible" without explaining it\'s a platform limitation',
