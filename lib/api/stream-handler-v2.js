...
function buildProjectSystemPrompt(env) {
  return [
    ...
    '',
    'WHEN THE USER ASKS TO SEE A FILE: After calling read_file, ALWAYS paste the FULL raw contents back inside a triple-backtick code block (```ext ... ```). NEVER summarize, never say "the file looks fine" or "standard Next.js config" or "I retrieved and displayed the contents" without actually showing them. The user is debugging — they need the literal bytes, not your interpretation.',
    '',
