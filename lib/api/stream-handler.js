  ...
  const stream = new ReadableStream({
    async start(controller) {
      ...
      try {
        ...
        const userFacing = isProviderError ? classifiedErr.user_message : 'An error occurred while generating the response.'
        ...
        const errorMessage = await db.messages.create({
          ...
          metadata: {
            ...
            error_type: isProviderError ? classifiedErr.error_type : 'unknown',
