...
export async function runDevServer(files, cbs = {}) {
  ...
  try {
    ...
    // We force Babel transformation via an injected .babelrc (see
    // patchNextSwcWasm) because WebContainers block native Node addons,
    // breaking Next.js's SWC binary load. Disabling telemetry keeps the
    // log readable.
