...
export const EXPORT_TARGETS = [
  ...
  { id: 'zip', name: 'ZIP Source', description: 'Download source code', icon: 'Archive' },
...
export const SELF_EDIT_TARGETS = [
  ...
  { id: 'dashboard', label: 'Dashboard', path: 'components/dashboard/Dashboard.jsx', description: 'Main dashboard component — chat UI, project management, stream handling, all user interactions' },
  { id: 'project_grid', label: 'Project Grid', path: 'components/dashboard/ProjectGrid.jsx', description: 'Project listing page — hero section, project cards, bulk select/delete, Core System button, credits modal. Edit this file for any project grid UI changes.' },
...
export function getChatType(chat) {
  return chat?.title?.startsWith(SELF_EDIT_PREFIX) ? CHAT_TYPES.SELF_EDIT : CHAT_TYPES.BUILDER
}
