...
export function buildThemeFile(tokens) {
  ...
  return `// AUTO-GENERATED by Auroraly from user reference images + brand brief.
 ...
 * @property {string}   testimonials_style  - 'card-grid' | 'single-quote-hero' | 'marquee-logos-plus-quote'
 * @property {string}   cta_style           - 'centered-rounded' | 'full-width-accent' | 'split-image'
...

{
  ...
  "testimonials_style": "card-grid" | "single-quote-hero" | "marquee-logos-plus-quote",
  "cta_style": "centered-rounded" | "full-width-accent" | "split-image",
...
- testimonials_style: pick "single-quote-hero" for one big centered pull-quote, "card-grid" for 3+ equal-sized cards, "marquee-logos-plus-quote" for a logo row + small quote.
- cta_style: pick "full-width-accent" for an edge-to-edge colored strip, "split-image" for 2-column with image, "centered-rounded" for a framed centered card.
...
export function parseBlueprint(raw) {
  ...
  return {
    ...
    testimonials_style: str(p.testimonials_style, ['card-grid', 'single-quote-hero', 'marquee-logos-plus-quote'], 'card-grid'),
    cta_style: str(p.cta_style, ['centered-rounded', 'full-width-accent', 'split-image'], 'centered-rounded'),
...
export function formatBlueprintForPrompt(bp) {
  ...
  - Testimonials: ${bp.testimonials_style || 'card-grid'}
  - Final CTA: ${bp.cta_style || 'centered-rounded'}
