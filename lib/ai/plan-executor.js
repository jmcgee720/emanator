...
Execute ALL file actions listed above. Use create_files for new files, update_files for modifications, and delete_files for removals.

## CRITICAL CODE QUALITY REQUIREMENTS — READ CAREFULLY:

1. **EACH PAGE MUST HAVE 5+ DISTINCT SECTIONS.** A header and hero alone is NOT acceptable. Every page needs:
   - Navigation bar with working links
   - Hero/banner section with headline, subtext, and CTA button
   - At MINIMUM 3 more content sections relevant to the page (e.g., product grid, features list, testimonials, pricing cards, team bios, FAQ accordion, contact form, newsletter signup, stats/metrics, gallery, how-it-works steps)
   - Footer with links and copyright

2. **USE REAL, SPECIFIC CONTENT** — not "Lorem ipsum" or "Description goes here". Write real headlines, real product names, real testimonial quotes, real FAQ answers that match the project brief.

3. **RICH TAILWIND STYLING** — Use gradients, shadows, rounded corners, hover effects, responsive grid layouts, spacing, and color. Pages should look like a real launched website, not a wireframe.

4. **Each file MUST be 150+ lines** of real JSX/code. If a file is under 100 lines, you are being lazy. Expand it with more sections and richer content.

5. **NEVER** write placeholder comments like "// Add more content here" or "// TODO". Write the actual content NOW.

6. Each file's "content" field MUST contain COMPLETE, VALID, RUNNABLE source code with real imports, real components, real styles.`
