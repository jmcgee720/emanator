...
import { buildProjectManagerPrompt, buildRefinementPrompt, buildNewPagePrompt, buildDesignExcellenceBlock } from './prompt-builder.js'
...
${buildDesignExcellenceBlock()}

## ADDITIONAL CODE QUALITY RULES:
1. **NEVER** write placeholder comments like "// Add more content here" or "// TODO". Write the actual content NOW.
2. Each file's "content" field MUST contain COMPLETE, VALID, RUNNABLE source code with real imports, real components, real styles.
3. If a file is under 150 lines, you are being lazy. Expand it with more sections, richer content, and deeper visual styling.`
