 ...
 * @param {{useSupabase?:boolean}} [opts] — when useSupabase=true, the scaffold
 *   wave swaps mock auth_context/mock_api for Supabase-wired variants and adds
 *   supabase_client. All other waves are unchanged.
 */
export function recipesForWave(waveId, archetypeId, opts = {}) {
  ...
  const scaffoldExtras = useSupabase ? ['supabase_client'] : []
