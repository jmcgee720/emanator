...
- Each page file MUST be a visually RICH, production-ready page — NOT a wireframe or stub
- Every page needs: sticky navigation, hero section with background image, 3+ rich content sections, footer
- Each page file should be described as "Full page with nav, hero, [specific sections], footer — 200+ lines"
- Plan for SEPARATE component files for each page (Home.jsx, About.jsx, Pricing.jsx, etc.) plus an App.jsx router
- Do NOT propose a single page.jsx file for multi-page projects
- In file_action descriptions, specify the sections each page will contain` : ''}
