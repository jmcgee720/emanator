...
- Call \`update_files\` with the COMPLETE modified file content.`
      ...
      const FORK_THRESHOLD_CHARS = 100000 // Suggest fork at ~25K tokens (~100K chars)
      
      // Check if we should suggest forking the chat
      const shouldSuggestFork = totalChars > FORK_THRESHOLD_CHARS && chatHistory.length > MAX_HISTORY_MESSAGES
