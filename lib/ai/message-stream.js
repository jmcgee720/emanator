...
- Call \`update_files\` with the COMPLETE modified file content.`
      ...
      const MAX_SYSTEM_MSG_CHARS = 100_000  // ~25K tokens — reduced from 200K to save tokens
      ...
      const MAX_HISTORY_MESSAGES = 10 // Keep only last 10 messages (5 turns) max
      ...
      const MAX_CONTEXT_CHARS = 200000 // Reduced from 350K to 200K for faster responses
