...
function identifyTargetFile(text, targets) {
  ...
  const keywordMap = [
    ...
    { keywords: ['project grid', 'project card', 'project tile', 'project bin', 'select all', 'bulk delete', 'delete all', 'project listing', 'new project card', 'hero section', 'creative brief'], target: 'ProjectGrid.jsx' },
    { keywords: ['dashboard', 'csv export', 'export button', 'workspace tab', 'chat panel', 'left panel', 'stream handling'], target: 'Dashboard.jsx' },
