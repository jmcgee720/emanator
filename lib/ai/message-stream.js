      ...
      if (toolMode === 'chat_only' && !usePlanMode) {
        ...
        if (isSelfEdit) {
          if (selfEditIsConversational) {
            ...
            // ACTION REQUEST: Force the AI to call a tool on the first attempt.
            // This is the key difference vs "auto" — with "required", GPT-4o MUST
            // call a tool and cannot just describe what it would do.
            // After the first tool call, the agent loop uses "auto" for follow-ups.
