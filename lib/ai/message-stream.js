...
1. Act immediately — call update_files or create_files with working code
2. Do NOT ask clarifying questions — the user has already specified what they want
3. Do NOT describe what you'll do — just do it
4. If you need to modify an existing file, use update_files with the COMPLETE file content
5. After the tool call, provide a 1-sentence summary of what you built`
      }
...
- After your create_files call, follow up with a short conversational summary of what you built. Do NOT ask questions.`
      ...
      if (toolMode === 'chat_only' && !usePlanMode) {
        ...
        if (isSelfEdit && !selfEditIsConversational) {
          effectiveToolSet = AI_TOOLS.filter(t => t.function?.name === 'patch_files' || t.function?.name === 'update_files' || t.function?.name === 'update_canvas')
        }
