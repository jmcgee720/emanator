...
// of whether the user's brief named them. This is how Emanator infers
 ...
 * @returns {{archetype: Archetype, confidence: number, ambiguous: boolean}}
 */
export function classifyArchetypeFast(briefText) {
  ...
  if (scores.length === 0) {
    return { archetype: ARCHETYPES.saas_tool, confidence: 0.3, ambiguous: true }
  }
  ...
  return { archetype: top.archetype, confidence, ambiguous: !!ambiguous }
}
