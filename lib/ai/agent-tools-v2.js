 ...
 * Optionally pass a `writer` (e.g. from buildGithubWriter) to route
 * write_file / edit_file through a remote writer instead of fs.
 */
export function buildDefaultToolset(rawScope, writer = null) {
  return [
