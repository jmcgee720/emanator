    ...
    async execute(args) {
      ...
      for (const img of inventory) {
        ...
        for (const el of elements) {
          ...
          // Extract capitalized words ≥4 chars that aren't stopwords.
          // These are typically proper-noun labels (page titles,
          // section names, app names) the model claims to see.
