...
const INSPECT_MODE_PATTERNS = [
  ...
  /\bplain\s+report\s+only\b/i,
  /\b(locate|find|show|report|investigate|audit|list|scan|search|check|verify|review|analyze|describe|explain|summarize|overview|status|detail|count|read|trace|walk\s*through|diagram|map|outline)\b/i,
