...
import { classifyIntent, getIntentWorkflow, getIntentSystemAddendum, shouldUsePlanMode, resolveTaskMode, classifyRequestMode, isSimpleFrontendEdit, findMainPagePath } from './intents.js'
  ...
  async *processMessageStream({ projectId, chatId, userMessage, userId, scope: requestedScope, designPrefs, executePlan, attachments, selfEditTarget }) {
    ...
    try {
      ...
      if (directEditMode && directEditTarget) {
        ...
        systemMessage += `\n\n## DIRECT EDIT MODE — Single Page Generation
...
- Output the COMPLETE file content — not a partial snippet.${isHtml ? `
...
- Use only React hooks (useState, useEffect, etc.) — no external npm packages.
- Do NOT include import statements for React — they are provided by the preview runtime.`}
- Make the design polished, modern, and responsive.
