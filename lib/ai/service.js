                ...
                if (!validationResult.valid) {
                  ...
                  if (revPlanCall) {
                    try {
                      ...
                      revArgs.autoExecute = (revArgs.file_actions || []).length <= 3 && !isLargeAppBuild(userMessage)
                    ...
                    if (critiqueContent.trim().toLowerCase().startsWith('issues found: yes')) {
                      ...
                      if (revisedPlanCall) {
                        try {
                          ...
                          revisedArgs.autoExecute = (revisedArgs.file_actions || []).length <= 3 && !isLargeAppBuild(userMessage)
