...
export function buildHeroPrimitive(layout, brand, opts = {}) {
  ...
  const header = `// AUTO-GENERATED primitive by Auroraly (Session 30).
...
export function buildFeatureGridPrimitive(columns, cardStyle, brand, opts = {}) {
  ...
  return `// AUTO-GENERATED primitive by Auroraly (Session 30).
...
export function buildPricingPrimitive(pattern, brand, opts = {}) {
  ...
  return `// AUTO-GENERATED primitive by Auroraly (Session 33).
// Pattern: ${picked}.
// DO NOT EDIT — regenerated on every build.
${imports}
...
export function formatPrimitivesForPrompt(blueprint) {
  ...
  return `PRIMITIVES — Auroraly has pre-composed these layout primitives from the user's blueprint. Import and USE them directly. Do NOT re-implement.
