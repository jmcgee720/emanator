...
`
  ...
  if (context.canvas) {
    ...
    if (brief) {
      msg += `\n### Creative Brief (User-Provided Direction)\nThe user has filled out a creative brief for this project. Follow these directives closely:\n`
      ...
      if (brief.most_important_page) msg += `**Most important page:** ${brief.most_important_page}\n`
      if (brief.must_have_features) msg += `**Must-have features:** ${brief.must_have_features}\n`
