...
4. **Features** (3 glass cards with icon, title, description)
5. **Stats** strip (3-4 big numbers with gradient text)
6. **How It Works** or testimonials section
7. **Pricing** or final CTA section
8. **Footer** with border-t border-white/5
