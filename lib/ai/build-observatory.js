...
export function buildManifest(opts = {}) {
  ...
  const screenshotVerify = opts.screenshotVerify || null
  const visualLoopSummary = opts.visualLoopSummary || null
  ...
  // Roll up every observability signal into a single 0-100 grade.
  manifest.qualityScore = computeQualityScore({
    manifest,
    screenshotVerify,
    visualLoopSummary,
  })
