...
`
  ...
  let rawFiles = []
  try {
    // Anthropic requires streaming for max_tokens this large (10+ min estimate).
    // chatWithToolsStream yields token deltas + tool_args_delta + a final
    // tool_calls bundle. We only need the final tool_calls.
