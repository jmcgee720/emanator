...
export const AI_TOOLS = [
  ...
  // ── Line-number-based editing tool — MOST RELIABLE for modifying existing files ──
  {
    type: 'function',
    function: {
      name: 'edit_lines',
      description: 'Edit an existing file using line numbers. This is the MOST RELIABLE way to modify code. First call read_files to see the numbered lines, then specify which lines to replace, insert after, or delete. You can make multiple edits per file — they are applied bottom-to-top so line numbers stay valid.',
      parameters: {
        type: 'object',
        properties: {
          path: {
