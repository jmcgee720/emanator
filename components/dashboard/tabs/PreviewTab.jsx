...
function buildReactPreview({ cssFiles, jsFiles, jsxFiles, tsFiles, usesTailwind, imageAssets }) {
  ...
  const html = [
    ...
    '    if (!C || C === w) return React.createElement("div",{"data-missing-component":modName, style:{padding:"1rem",color:"#f97316",fontSize:"13px",fontFamily:"monospace"}},"[" + modName + " not found]");',
