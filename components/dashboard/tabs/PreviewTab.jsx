...
function buildReactPreview({ cssFiles, jsFiles, jsxFiles, tsFiles, usesTailwind }) {
  ...
  const html = [
    ...
    'var BrowserRouter = _RR.BrowserRouter || function(p){return createElement("div",null,p.children);};',
    'var HashRouter = _RR.HashRouter || function(p){return createElement("div",null,p.children);};',
    'var MemoryRouter = _RR.MemoryRouter || function(p){return createElement("div",null,p.children);};',
    'var Router = _RR.Router || BrowserRouter;',
    'var Routes = _RR.Routes || function(p){return createElement("div",null,p.children);};',
    'var Route = _RR.Route || function(){return null;};',
    'var Link = _RR.Link || function(p){return createElement("a",{href:p.to||"#"},p.children);};',
    ...
    'var Switch = _RR.Switch || _RR.Routes || Routes;',
    'var Redirect = _RR.Redirect || Navigate;',
