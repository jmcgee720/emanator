...
Testing sandbox feature endpoints at https://emanator-validate.preview.emergentagent.com
...
class SandboxBackendTester:
    def __init__(self):
        self.base_url = "https://emanator-validate.preview.emergentagent.com/api"
