...
Testing sandbox feature endpoints at https://api-feature-extract.preview.emergentagent.com
...
class SandboxBackendTester:
    def __init__(self):
        self.base_url = "https://api-feature-extract.preview.emergentagent.com/api"
